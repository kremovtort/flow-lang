...
type ModDefinitionBody ann = ModDefinitionBodyF Mod Statement PatternSimple Pattern Type Expression ann

data Mod ann = Mod
  { mod :: ModF Mod Statement PatternSimple Pattern Type Expression ann
  , ann :: ann
  }
